...
|                                                                             |                                                                         |                                                                           |
| :-------------------------------------------------------------------------: | :---------------------------------------------------------------------: | :-----------------------------------------------------------------------: |
| ![correctly recognizes an image of a starfish](./attachments/starfish.webp) | ![correctly recognizes an image of bananas](./attachments/bananas.webp) | ![correctly recognizes an image of a macbook](./attachments/macbook.webp) |
...
![UI & Camera setup](./attachments/ui-and-camera-setup.gif)
...
![UI & Camera setup](./attachments/ui-and-camera-setup-2.gif)
