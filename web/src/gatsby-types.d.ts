...
type BlogPostTemplateQuery = { readonly site: { readonly siteMetadata: { readonly title: string | null } | null } | null, readonly markdownRemark: { readonly id: string, readonly excerpt: string | null, readonly html: string | null, readonly frontmatter: { readonly title: string | null, readonly date: string | null, readonly description: string | null, readonly image: { readonly childImageSharp: { readonly fluid: { readonly src: string } | null } | null } | null } | null } | null, readonly previous: { readonly fields: { readonly slug: string | null } | null, readonly frontmatter: { readonly title: string | null } | null } | null, readonly next: { readonly fields: { readonly slug: string | null } | null, readonly frontmatter: { readonly title: string | null } | null } | null };
...
type SiteMetadataTitleQueryVariables = Exact<{ [key: string]: never; }>;


type SiteMetadataTitleQuery = { readonly site: { readonly siteMetadata: { readonly title: string | null } | null } | null };

type XQueryVariables = Exact<{ [key: string]: never; }>;


type XQuery = { readonly allMarkdownRemark: { readonly nodes: ReadonlyArray<{ readonly id: string, readonly fields: { readonly slug: string | null } | null }> } };
